function [  ] = cpiPlot( trace )
% plot the cpi, ideal cpi, ideal misaligned cpi on bar plot
...
% format data to plot
cpi = [ All_2way.cpi, All_2way.idealMisACPI, All_2way.idealCPI; ...
        All_4way.cpi, All_4way.idealMisACPI, All_4way.idealCPI; ...
